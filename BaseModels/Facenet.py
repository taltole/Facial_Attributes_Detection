...
def loadModel(url='https://drive.google.com/uc?id=1971Xk5RwedbudGgTIrGAL4F7Aifu7id1'):
    ...
    if not os.path.isfile(os.path.join(WEIGHT_PATH, 'facenet_weights.h5')):
        print("facenet_weights.h5 will be downloaded...")

        output = os.path.join(WEIGHT_PATH, 'facenet_weights.h5')
        gdown.download(url, output, quiet=False)

    # -----------------------------------

    model.load_weights(os.path.join(WEIGHT_PATH, 'facenet_weights.h5'))
